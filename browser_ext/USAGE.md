...
3. Quick save → Ctrl+Shift+Y → Done!
```

### Research & Bulk Collection (Advanced Mode)
```
1. On a page with many useful links → Ctrl+Shift+Q
...
- **Preview before adding:** In Advanced Mode, click "Preview" to see what links will be collected
- **Quick selectors:** Use the preset buttons for common patterns
- **Visual feedback:** Matched elements are highlighted temporarily during preview
...
- [ ] Test advanced mode: `Ctrl+Shift+Q` → try selector `a`
- [ ] Verify URLs appear in your DLM system

---

**Need help?** Check the main README.md for detailed installation and setup instructions.